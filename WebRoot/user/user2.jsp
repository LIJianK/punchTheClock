...
%>	
	...
	<div align="center" id="1" style="display:none;height:30px;background-color:#FAA5DA;" onclick="f(<%=user.getUserId() %>);">
		<font><label >关注</label></font>
	</div>
	<div align="center" id="2" style="display:block;height:30px;background-color:#DDDDDD;" onclick="g(<%=user.getUserId() %>);">
